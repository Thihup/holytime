...
cd ..
jlink --module-path mods:mods/javafx-jmods-$openjfx_version:mods/jaxb-ri/mod:mods/jaxws-ri/lib --add-modules $modules --output "jdk-linux" --compress zip-6 --generate-cds-archive
